...
namespace RestaurantManagementSystem.Pages.MenuItems
{
    ...
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGet(int? id)
        {
            ...
            {
                MenuItem = _db.MenuItem.Include(m => m.Restaurant).Include(m => m.FoodType).SingleOrDefault(m => m.Id == id),
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            MenuItemFromdb.RestaurantId = MenuItemVM.MenuItem.RestaurantId;
