...
namespace RestaurantManagementSystem.Pages
{
    ...
    public class DetailsModel : PageModel
    {
        ...
        {
            var MenuItemFromDb=_db.MenuItem.Include(m=>m.Restaurant).Include(m=>m.FoodType)
        ...
        public IActionResult OnPost()
        {
            ...
            {
                var MenuItemFromDb = _db.MenuItem.Include(m => m.Restaurant).Include(m => m.FoodType).FirstOrDefault();
